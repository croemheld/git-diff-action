...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.runGitDiff = exports.parseGitDiff = exports.runGitCommand = void 0;
...
function runGitCommand(args) {
    const spawned = (0, child_process_1.spawnSync)('git', args, { shell: true });
    if (spawned.error) {
...
const minimatch = __importStar(__nccwpck_require__(973));
const git_1 = __nccwpck_require__(350);
/**
 ...
 */
function getGlobMap(diffMap, globStr) {
    const globMap = new Map();
    const fileArr = [...diffMap.keys()];
    const globArr = fileArr.filter(minimatch.filter(globStr, { matchBase: true }));
    for (const value of globArr) {
        globMap.set(value, diffMap.get(value) || 'X');
    }
    return globMap;
}
function getCharMap(diffMap) {
...
async function run() {
    try {
        ...
        const diffMap = (0, git_1.runGitDiff)(baseStr, compStr);
